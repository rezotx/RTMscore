...
# Reference values captured from PyG code (Python 3.12, torch 2.2,
# PyG 2.7, MDAnalysis 2.10). See PYG-MIGRATION.md for equivalence
# analysis vs original DGL baseline (Spearman rho=0.986, top-10
# identical).
E2E_PREDS_FIRST10 = [
    42.68037758648402,
    45.79706452917272,
